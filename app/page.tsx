...
export default function Home() {
  ...
  return <main>
    <header className="topbar"><a className="brand" href="#top"><OrbitMark /><span>蓝星能量星图</span></a><nav><a href="#milestones">进度星图</a><a href="#principles">核心准则</a></nav><span className="system-status"><i /> 系统在线</span></header>
