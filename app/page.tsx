...
export default function Home() {
  ...
  const allProgress = useMemo(() => {
    ...
    return combined.map((item, index) => ({ ...item, current: index === combined.length - 1 }));
  }, [progressUpdates]);
