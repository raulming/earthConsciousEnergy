...
export default function Home() {
  ...
  return <main>
    ...
    <section className="principles" id="principles"><div className="principles-inner"><div><p className="eyebrow">CORE PROTOCOL</p><h2>共心同一，方能行稳致远。</h2><p>放下固有成见，倾听不同声音；心性稳定、知行合一，将大爱传递到每一处坐标。</p></div><div className="protocols"><span>01 <b>不攀比</b></span><span>02 <b>不懈怠</b></span><span>03 <b>自我觉察</b></span><span>04 <b>服务整体</b></span></div></div></section>
